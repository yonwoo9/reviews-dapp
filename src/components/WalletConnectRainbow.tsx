              ...
              {(() => {
                ...
                return (
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <div
                      className="bg-white/10 backdrop-blur-sm px-3 py-2 h-10 rounded-lg border border-white/20 flex items-center gap-2 whitespace-nowrap flex-shrink-0"
                      style={{ minWidth: 'fit-content' }}>
